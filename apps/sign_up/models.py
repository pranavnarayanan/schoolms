...
class EN_UserRegistration(models.Model):
    ...
    permanent_house_name = models.CharField(max_length=100, unique=False, null=True)
    permanent_street     = models.CharField(max_length=100, unique=False, null=True)
    permanent_landmark   = models.CharField(max_length=100, unique=False, null=True)
    permanent_zipcode    = models.ForeignKey(EN_Zipcode, on_delete=models.PROTECT, null=True,related_name='permanent_zipcode')
    is_current_address   = models.BooleanField(default=True)

    current_house_name   = models.CharField(max_length=100, unique=False, null=True)
    current_street       = models.CharField(max_length=100, unique=False, null=True)
    current_landmark     = models.CharField(max_length=100, unique=False, null=True)
    current_zipcode      = models.ForeignKey(EN_Zipcode, on_delete=models.PROTECT, null=True,related_name='current_zipcode')
