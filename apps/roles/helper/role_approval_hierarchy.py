...
class RoleApprovalHierarchy():
    ...
    SCHOOL_ADMIN_APPROVAL_LIST   = [Roles.TEACHER,Roles.PRINCIPAL,Roles.STUDENT,Roles.PARENT,Roles.LIBRARIAN,Roles.ACCOUNTANT,Roles.LAB_ASSISTANT,Roles.ENQUIRY_ASSISTANT,Roles.SECURITY]
